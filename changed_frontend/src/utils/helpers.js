...
// Function to transform script by joining lines with newline characters
...
// Function to transform input by replacing commas with spaces
...
export const compileCode = async (language, code, input = undefined) => {
  ...
  // Adjust bodyData for promptv1 and promptv2 languages
  ...
  try {
    ...
    // Return output, compile_message, or message from result
